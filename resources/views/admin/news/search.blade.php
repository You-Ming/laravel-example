...
@section('title', 'Admin - News Search')
...
<div id='admin_news'>
    ...
    @endif
    <div align="center">
        <button type="button" class="btn btn-primary" onclick="window.location.href='{{ route('admin.news.index') }}'">返回新聞列表</button>
    </div>
</div>
@endsection