...
@section('title', 'Admin - Contact Search')
...
<div id='admin_contact'>
    ...
    @endif
    <div align="center">
        <button type="button" class="btn btn-primary" onclick="window.location.href='{{ route('admin.contact.index') }}'">返回留言列表</button>
    </div>
</div>
